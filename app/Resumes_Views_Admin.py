...
def  view_resume(request):
    show_resume = Resume.objects.all()
    content = {
        'show_resume':show_resume,
        # 'num_visits':num_visits,
    }
    return render(request , 'home/tables.html' , content)
...
def VIEWS_POST(request):
    view = job_post.objects.all()
    return render(request , 'home/view_post.html' , {'view':view})
